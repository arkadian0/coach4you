...
public class CoachFactory {
  ...
  public static Coach getCoach() {
    PersonDetails personDetails = new PersonDetails("John", "Lenon",
        "j.lenon@gmail.com", (short) 15);
    ...
    return new Coach(personDetails, "2-4", "Best coach on the world",
        List.of("Coach", "Instructor"), sportSpecializations, activitySpecializations);
  }

  public static CoachDbModel getCoachDbModel() {
    List<ActivityDictionaryDbModel> activitySpecializations = List.of(
        ActivityDictionaryDbModel.builder()
            .id(1L)
            .description("For children")
            .code(ActivityType.FOR_CHILDREN)
            .build());
    List<SportDictionaryDbModel> sportSpecializations = List.of(
        SportDictionaryDbModel.builder()
            .id(1L)
            .code(SportType.FOOTBALL)
